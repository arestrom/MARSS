      ...
      wellPanel(
        ...
        tippy("<i style='color:#1a5e86;padding-left:8px', class='fas fa-info-circle'></i>",
              tooltip = glue("<span style='font-size:11px;'>",
                             ...
                             "values such as password, host, and port. After you have ",
                             "successfully tested the connection you will need to close ",
                             "the application and restart. The connection values will be ",
                             "encrypted and stored in your Windows Credential store after ",
                             "a successful test. You will not have to do this again ",
